...
cat bin/loader.bin bin/fat.bin bin/fat.bin bin/fdt.bin bin/stage2.bin > bin/combined_disk.img
qemu-img convert -f raw -O qcow2 bin/combined_disk.img floppy_img.qcow2
